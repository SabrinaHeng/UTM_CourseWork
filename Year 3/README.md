...
Welcome to my third year of studying **Bachelor of Computer Science (Data Engineering)** at **Universiti Teknologi Malaysia (UTM)**.

Year 3 marked my transition into specialized Data Engineering and Analytics topics. The courses focused on extracting insights from data, designing intelligent systems, processing large-scale datasets, and applying business intelligence techniques to support decision-making.Through hands-on projects and data-driven applications, I strengthened both my technical and analytical skills while gaining practical experience in solving real-world problems using data.
